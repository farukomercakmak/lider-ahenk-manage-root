...
1. Create a soft link for _ahenk-manage-root/manage-root_ directory via `sudo ln -s lider-ahenk-manage-root-plugin/ahenk-manage-root/manage-root/ /opt/ahenk/plugins`

 ...
 * 
 */
public class manage-rootTaskDialog extends DefaultTaskDialog {
	
	private static final Logger logger = LoggerFactory.getLogger(manage-rootTaskDialog.class);
	
	// TODO do not forget to change this constructor if SingleSelectionHandler is used!
	public manage-rootTaskDialog(Shell parentShell, Set<String> dnSet) {
